...
- [Hivemind] adds selectable failsafe behavior (LAND or RTL)
- [Hivemind] turns lights on automatically on the ground after failsafe disarm
- [Hivemind] adds upgraded, phase-aware telemetry packet
- [Hivemind] adds additional hardware information like total vehicle flight time

## Enhancements

- [Maestro] adds additional continuous integration tests and workflows
- [Maestro] fixes various compiler warnings
...
- [Hivemind] enables anti-collision lights on failsafe
- [Hivemind] adds dynamic error threshold for spatial error
- [Hivemind] flight plan memory management improvements
- [Hivemind] post mission flags improvements
- [Hivemind] nixie ring buffer for network efficient processing
...
- [PX4] adds 'can arm' event for knowing whether or not the drone is armable
...
- [Hivemind] drops stm32f7 support
